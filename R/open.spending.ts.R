...
#' 
#' @usage open_spending.ts(json_data, time, amount, 
...
#' 
#' @return A json string with the resulted parameters of the \code{\link{ts.analysis}} 
#' function.
#'
...
open_spending.ts <- function(json_data, time, amount, 
                             order = NULL, prediction_steps = 1) {
